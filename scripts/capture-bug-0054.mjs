...
for (const item of cases) {
  ...
  const response = await page.goto('http://127.0.0.1:5006/ecosystem/why-esg-matters-to-green', { waitUntil: 'networkidle', timeout: 60000 });
  await page.waitForTimeout(1200);
  await page.screenshot({ path: `/home/ubuntu/green-ai-waaj529/test-results/bug-0054/baseline-${item.name}.png`, fullPage: false });
