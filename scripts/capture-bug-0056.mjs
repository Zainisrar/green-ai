...
for (const item of cases) {
  ...
  const response = await page.goto('http://127.0.0.1:5006/empower/careers-at-green', { waitUntil: 'networkidle', timeout: 60000 });
  await page.waitForTimeout(900);
  const screenshot = `/home/ubuntu/green-ai-waaj529/test-results/bug-0056/baseline-${item.name}.png`;
  await fs.mkdir('/home/ubuntu/green-ai-waaj529/test-results/bug-0056', { recursive: true });
