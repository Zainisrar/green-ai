...
for (const item of cases) {
  ...
  const response = await page.goto('http://127.0.0.1:5006/empower/green-talent-incubator', { waitUntil: 'networkidle', timeout: 60000 });
  await page.waitForTimeout(900);
  await fs.mkdir('/home/ubuntu/green-ai-waaj529/test-results/bug-0057', { recursive: true });
  await page.screenshot({ path: `/home/ubuntu/green-ai-waaj529/test-results/bug-0057/baseline-${item.name}.png`, fullPage: false });
