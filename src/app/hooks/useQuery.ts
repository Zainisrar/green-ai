...
export const queryKeys = {
  ...
  certificationsAccreditations: () =>
    [...queryKeys.all, "certifications-accreditations"] as const,
  sustainabilityESG: () => [...queryKeys.all, "sustainability-esg"] as const,
  solarEPCMServices: () => [...queryKeys.all, "solar-epcm-services"] as const,
  hybridMicrogridSolutions: () =>
    [...queryKeys.all, "hybrid-microgrid-solutions"] as const,
  energyStorageSmartGrid: () =>
    [...queryKeys.all, "energy-storage-smart-grid"] as const,
  ...
  collaborationInnovation: () =>
    [...queryKeys.all, "collaboration-innovation"] as const,
  communityImpactLoop: () =>
    [...queryKeys.all, "community-impact-loop"] as const,
} as const;
