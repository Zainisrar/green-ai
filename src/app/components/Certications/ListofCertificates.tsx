...
const ListofCertificates = ({ isOpen, onClose }: Props) => {
  ...
  const getVisibleCertificates = () => {
    ...
    if (isMobile) {
      ...
      for (let i = 0; i < 3; i++) {
        const index =
          (currentIndex - 1 + i + certificates.length) % certificates.length;
        ...
        <div className="relative w-full  mx-4 h-full flex items-center justify-center">
          ...
          >
            <img
              loading="lazy"
              decoding="async"
              src="/images/certifications-accredication/close-icon.png"
              alt="Close"
              className="w-8 h-8"
            />
          </button>
          ...
          >
            <img
              loading="lazy"
              decoding="async"
              src="/images/certifications-accredication/left-arrow.png"
              alt="Previous"
          ...
          <div className="flex items-center justify-center w-full h-full px-4 lg:px-20">
            ...
            <div
              className={`flex items-center justify-center w-full ${isMobile ? "" : "gap-4"}`}
            >
          ...
          >
            <img
              loading="lazy"
              decoding="async"
              src="/images/certifications-accredication/right-arrow.png"
              alt="Next"
              className="w-12 h-12"
            />
          </button>
