...
const defaultItems = [
  { greenDelivers: "Track record in hard-to-reach zones", othersPromise: "Marketing slides" },
  { greenDelivers: "In-house execution, no over-subcontracting", othersPromise: "Outsourced chaos" },
  { greenDelivers: "GRID-INTEL™ platform with every system", othersPromise: "Static installations" },
  { greenDelivers: "High uptime. Low maintenance. Localized O&M", othersPromise: "Unplanned breakdowns" },
  { greenDelivers: "Full post-handover support ecosystem", othersPromise: "Silence after delivery" },
];
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
        <div>
          ...
          <div className="space-y-4">
            {items.map((item, idx) => (
              <p key={idx} className="text-base font-medium text-gray-800 sm:text-center sm:text-lg">
                {item.greenDelivers}
              </p>
            ))}
          </div>
