...
const ResearchCoDevelopment = ({ isOpen, onClose, title, subHeadline, description, img, keys, quote }: Props) => {
            ...
            <div className="">
              ...
              <div className="mb-8">
                <h2 className="text-3xl font-black text-gray-800 mb-4">
                  {title.trim() || "Research & Co-Development"}
                </h2>
                {subHeadline && (
                  <h3>
              ...
              <div className="flex flex-col lg:flex-row items-start gap-8">
                ...
                <div className=" lg:w-6/12">
                  <img
                    src={img?.src || "/images/technology-innovation-alliances/researchdevelopment.png"}
                    alt={img?.alt || "Research & Co-Development"}
                    className="w-full"
