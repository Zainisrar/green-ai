...
const CurrentTechnologyCollaborators = ({ isOpen, onClose, title, subHeadline, description, img, keys, quote }: Props) => {
            ...
            <div className="">
              ...
              <div className="mb-8">
                <h2 className="text-3xl font-black text-gray-800 mb-4">
                  {title.trim() || "Current Technology Collaborators"}
                </h2>
                {subHeadline && (
                  <h3>
                  ...
                  {keys?.map((k, i) => (
                    <div key={i} className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        {k.highlighted && (
                          <span className="text-green-600"> {k.highlighted}</span>
                        )}
                      </div>
                    </div>
                  ))}
...
export default CurrentTechnologyCollaborators;
