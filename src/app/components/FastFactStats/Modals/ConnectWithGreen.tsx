...
const ConnectWithGreen = ({ isOpen, onClose }: Props) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const message = [
      "Connect with GREEN (Fast Facts & Stats)",
  ...
  return (
    <EngineeringFormModal
      ...
      title={
        <>
          CONNECT WITH <span className="text-green-600">GREEN</span>
        </>
      }
    >
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          />
          <label htmlFor="connect-agree" className="text-sm text-gray-700 sm:text-base">
...
export default ConnectWithGreen;
