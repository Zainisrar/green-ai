...
const BalanceofSystem = ({ isOpen, onClose, data }: Props) => {
    ...
    <>
      ...
      <div className="mb-8">
        <h2 className="text-2xl lg:text-3xl font-black text-gray-800 mb-4">
          {data?.title || "Balance of System (BoS)"}
        </h2>
      ...
      {isMobile ? (
        ...
        <div className="space-y-4">
          {(data?.item || [
            { component: "AC Cabling & Distribution", technicalNotes: "XLPE armored cables, properly derated, color-coded to AS/NZS 3000 standards" },
            { component: "Earthing Systems", technicalNotes: "Copper-bonded rods, ≤5Ω resistance, SPD-integrated grounding at inverter & battery level" },
            { component: "Enclosures & Cabinets", technicalNotes: "IP-rated (IP55/IP65), UV & corrosion resistant, stainless/galvanized steel; custom busbar-ready" }
          ]).map((item, index) => (
