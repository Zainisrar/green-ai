...
const PowerConversionSystems = ({ isOpen, onClose, data }: Props) => {
    ...
    <>
      ...
      <div className="mb-8">
        <h2 className="text-2xl lg:text-3xl font-black text-gray-800 mb-4">
          {data?.title || "Power Conversion Systems"}
        </h2>
      ...
      {isMobile ? (
        ...
        <div className="space-y-4">
          {(data?.item || [
            { component: "Inverters", technicalNotes: "Hybrid/off-grid capable, MPPT tracking, load-shedding logic, min. 95% EU efficiency; Victron/SMA/Studer equivalent or higher" },
            { component: "Charge Controllers", technicalNotes: "MPPT preferred, compatibility with LFP/VRLA banks, current capacity ≥50A DC; real-time data sync capability" },
            { component: "ATS / Switchgear", technicalNotes: "Dual-input synchronization, <10ms changeover, built-in surge & arc protection, IP65+ enclosures" }
          ]).map((item, index) => (
...
export default PowerConversionSystems;
