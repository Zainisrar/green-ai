...
/* ================================================================== */
export const ProgressGauge: React.FC<{ value: number; suffix?: string }> = ({
  value,
  suffix = "%",
}) => {
  const cx = 130;
...
/* ================================================================== */
export const DonutChart: React.FC<{ value: number; centerLabel?: string }> = ({
  value,
  centerLabel,
}) => {
  const size = 160;
