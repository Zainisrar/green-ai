...
const StorageSystemReview = ({ isOpen, onClose }: Props) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const message = [
      "Energy Storage & Smart Grid — Book a Storage System Review",
      `Organization: ${formData.organization}`,
      `System / project name: ${formData.systemName}`,
    ...
    try {
      ...
      if (data.Code === "001") {
        setSuccessMessage(
          data.Message ||
            "Your storage system review request has been submitted successfully!",
        );
        resetForm();
        setTimeout(() => {
          onClose();
  ...
  return (
    <ProductEnquiryFrame
      ...
      onClose={onClose}
      closeLabel="Close storage system review dialog"
    >
      <div className={styles.content}>
        <header className={styles.dialogHeader}>
          <h2 id="storage-review-title">
            BOOK A <strong>STORAGE SYSTEM REVIEW</strong>
          </h2>
          <p>
            Schedule a comprehensive review of your energy storage
            infrastructure with our engineering team.
          </p>
        </header>
        ...
        <form className={styles.form} onSubmit={handleSubmit}>
          ...
          <div className={`${styles.row} ${styles.row3}`}>
            ...
            <div className={styles.fieldShape}>
              ...
              >
                ...
                <option value="storage-review">Storage System Review</option>
                <option value="sizing">Sizing &amp; Design</option>
                <option value="performance-audit">Performance Audit</option>
                <option value="bess-integration">BESS Integration</option>
          ...
          <div className={`${styles.row} ${styles.row6}`}>
            ...
            >
              <span>{isLoading ? "Submitting..." : "Book Review"}</span>
            </button>
          </div>
        </form>
      </div>
...
export default StorageSystemReview;
