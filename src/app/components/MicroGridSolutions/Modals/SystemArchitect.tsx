...
const SystemArchitect = ({ isOpen, onClose }: Props) => {
  ...
  return (
    <EngineeringFormModal
      ...
      title={
        <>
          TALK TO A <span className="text-green-600">SYSTEM ARCHITECT</span>
        </>
      }
    >
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        ...
        <div className={formGridClass}>
          ...
          >
            ...
            <option value="hybrid-microgrid">Hybrid / Microgrid Sizing</option>
        ...
        <div className="flex items-start gap-3">
          ...
          />
          <label htmlFor="architect-agree" className="text-sm text-gray-700 sm:text-base">
