...
import styles from "./PublicEventModalFrame.module.css";

interface PublicEventModalFrameProps {
  isOpen: boolean;
  onClose: () => void;
  title: string;
  titleDash?: string;
...
export default function PublicEventModalFrame({
  isOpen,
  onClose,
  title,
  titleDash,
  ...
  // Manage focus on open and restore on close
  useEffect(() => {
  ...
  // Keep this independent from callbacks such as onClose. A parent may
  // recreate those callbacks while the dialog is open; that must not cause
  // the saved body overflow value to be overwritten with "hidden".
  useEffect(() => {
    if (!isOpen) return;
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      // Tab cycle guard to trap focus inside the dialog
        ...
        <div className={styles.modal}>
          ...
          >
            ...
            <path
              ...
              fill="#ffffff"
              stroke="url(#publicEventModalBorderGrad)"
              strokeWidth="3"
