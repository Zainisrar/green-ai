...
import styles from "./InvestorModalShell.module.css";

interface InvestorModalShellProps {
  isOpen: boolean;
  onClose: () => void;
  title: string;
  headline?: string;
  ...
  return (
    <div className={styles.overlay}>
      <div
        ...
        tabIndex={-1}
      >
        {/* Slanted Card SVG Background matching Figma Vector 7376 */}
        <svg
        ...
        >
          <defs>
            <linearGradient
              id="investorModalBorderGrad"
              x1="0%"
              y1="0%"
              x2="100%"
              y2="0%"
            >
              <stop offset="0%" stopColor="#23B14D" stopOpacity="0.7" />
              <stop offset="100%" stopColor="#FFFE50" stopOpacity="0.7" />
            </linearGradient>
          </defs>
          <path
            d="M265 1.5H1864.5L1600.5 698.5H1.5L265 1.5Z"
            fill="#FFFFFF"
            stroke="url(#investorModalBorderGrad)"
            strokeWidth="3"
          />
        </svg>

        {/* Top-Right Close Button matching Figma Line 386 & Line 387 */}
        <button
          type="button"
          onClick={onClose}
