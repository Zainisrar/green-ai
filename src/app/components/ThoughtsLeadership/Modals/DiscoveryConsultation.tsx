...
const DiscoveryConsultation = ({ isOpen, onClose }: Props) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const message = [
      "Book a Discovery Consultation (Thought Leadership)",
      `Area of interest: ${formData.areaOfInterest}`,
      `Brief requirements: ${formData.requirements || "None"}`,
    ].join("\n");
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          />
          <label htmlFor="thought-consult-agree" className="text-sm text-gray-700 sm:text-base">
