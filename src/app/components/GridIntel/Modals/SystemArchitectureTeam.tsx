...
const SystemArchitectureTeam = ({ isOpen, onClose }: Props) => {
  ...
  return (
    <EngineeringFormModal
      ...
      title={
        <>
          ENGAGE OUR <span className="text-green-600">SYSTEM ARCHITECTURE TEAM</span>
        </>
      }
    >
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        ...
        <div className={formGridClass}>
          ...
          >
            ...
            <option value="grid-modeling">Grid Modeling &amp; Simulation</option>
        ...
        <div className="flex items-start gap-3">
          ...
          />
          <label htmlFor="architecture-agree" className="text-sm text-gray-700 sm:text-base">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:justify-end sm:gap-6">
          ...
          >
            <span className="block text-sm font-bold text-gray-900 sm:text-base">
              {isLoading ? "Submitting..." : "Engage Team"}
            </span>
          </button>
        </div>
      </form>
