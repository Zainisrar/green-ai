    ...
    <GridIntelInfoModal isOpen={isOpen} onClose={onClose}>
      <div className="mb-8">
        <h2 className="mb-2 text-3xl font-black leading-tight text-gray-800 lg:text-4xl">
          Why GRID-INTEL™{" "}
          <span className="text-xl text-[#4CAF50] lg:text-2xl">
            - Is Different
          </span>
        </h2>
      </div>
      ...
      <div className="overflow-x-auto">
        <div className="min-w-[640px]">
          <div className="grid grid-cols-3">
            <div className="px-4 py-3 font-bold text-[#4CAF50] sm:px-6 sm:py-4">
              Feature
            </div>
            <div className="px-4 py-3 font-bold text-[#4CAF50] sm:px-6 sm:py-4">
              GRID-INTEL™
          ...
          {[
            ...
            >
              <div className="px-4 py-3 font-medium text-gray-800 sm:px-6 sm:py-4">
                {feature}
              </div>
              <div className="px-4 py-3 text-gray-800 sm:px-6 sm:py-4">
                {gridIntel}
              </div>
              <div className="px-4 py-3 text-gray-800 sm:px-6 sm:py-4">
                {conventional}
