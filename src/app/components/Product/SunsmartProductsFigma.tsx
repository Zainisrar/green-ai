...
export default function SunsmartProductsFigma() {
  ...
  const desktop = (
    <main className={styles.desktop} data-node-id="7077:25900">
      ...
      <ProductBrandSwitcher current="GREEN SunSmart" />
      ...
      <img
        loading="lazy"
        decoding="async"
        className={`${styles.productTopBrandLogo} ${styles.sunsmartTopBrandLogo}`}
        src="/images/product/green-sunsmart.png"
        alt=""
        data-node-id="7077:26001"
      />
      <img
        loading="lazy"
        decoding="async"
          ...
          {gallery.map(([image, alt], index) => (
            ...
            >
              <img
                loading="lazy"
                decoding="async"
                src={`/images/product/sunsmart/${image}`}
                alt={alt}
              />
            </button>
          ))}
  ...
  return (
    <>
      <FigmaPageCanvas desktop={desktop} mobile={mobile} nodeId="7077:25900" />
      <ProductEnquiry
