...
const FALLBACK_DATA = {
  ...
  mainPage: {
    title: "Team GREEN",
    subHeadline:
      "Built by Engineers. Driven by Mission. Grounded in Community.",
    description: {
      text: "GREEN is powered by a team that spans disciplines, geographies, and generations — but is united by one belief: Clean energy should be reliable, inclusive, and transformative.",
      highlighted: "GREEN",
    },
    quote1: {
      text: "A team with the courage to build differently.",
      highlighted: "courage",
    },
    quote2: {
      text: "Team GREEN doesn't clock in. We show up — because lives depend on it.",
      highlighted: "GREEN",
    },
    keys: [
      {
        title: "Who We Are",
        description: "People, disciplines, and purpose moving together.",
        button: { href: "#who-we-are", text: "Explore" },
      },
      {
        title: "Our Leadership Philosophy",
        description: "Lead with clarity, humility, and accountability.",
        button: { href: "#leadership", text: "Explore" },
      },
      {
        title: "Meet the Team",
        description: "The people turning intention into action.",
        button: { href: "#meet-the-team", text: "Explore" },
      },
      {
        title: "Our Culture in Action",
        description: "A culture shaped by how we work every day.",
        button: { href: "#culture", text: "Explore" },
      },
    ],
    cta: [{ href: "#work-with-us", text: "Work With Us" }, TEAM_BRIEF_CTA],
  },
  whoWeAreModal: {
    img: {
    ...
    quote: {
      text: "Different disciplines. One mission.",
      highlighted: "mission",
    },
    title: "Who We Are",
    title2: "",
  ...
  ourLeadershipPhilosophy: {
    ...
    keyPoints: [],
    qualities: [],
    description: "We lead with clarity, humility, and accountability.",
  },
  meetTeam: {
    quote: {
      text: "Meet the people behind the work.",
      text1: "Meet the people",
      text2: "behind the work.",
      highlighted: "people",
  ...
  ourCultureActionModal: {
    img: "/images/team-green/mainImg.png",
    keys: [],
    quote: "Culture is how we deliver.",
    title: "Our Culture in Action",
    keypoint: [],
    description: "",
    quoteHighlighted: "deliver",
  },
};

const TeamGreen = ({ canvas = false }: { canvas?: boolean }) => {
  const [isWhoWeAreOpen, setIsWhoWeAreOpen] = React.useState(false);
  const [isOurLeadershipPhilosophyOpen, setIsOurLeadershipPhilosophyOpen] =
    React.useState(false);
  const [isMeettheTeamOpen, setIsMeettheTeamOpen] = React.useState(false);
  const [isOurCultureinActionOpen, setIsOurCultureinActionOpen] =
    React.useState(false);
  ...
  const canvasRows = [
    {
      ...
      onClick: () => setIsWhoWeAreOpen(true),
    },
    {
      label: "Our Leadership Philosophy",
      description: "Our leadership is PNG-rooted and\nglobally aligned",
      onClick: () => setIsOurLeadershipPhilosophyOpen(true),
    },
    {
      label: "Meet the Team",
      description: "Team GREEN doesn't clock in. We show up",
      onClick: () => setIsMeettheTeamOpen(true),
    },
    {
      label: "Our Culture in Action",
      description: "it's my way to shape the future of PNG",
    ...
    return (
      <main className={styles.canvasPage} data-node-id="7077:21015">
        ...
        <OurLeadershipPhilosophy
          ...
          onClose={() => setIsOurLeadershipPhilosophyOpen(false)}
          data={data.ourLeadershipPhilosophy}
        />
        <MeettheTeam
          isOpen={isMeettheTeamOpen}
          onClose={() => setIsMeettheTeamOpen(false)}
          data={data.meetTeam}
        />
        <OurCultureinAction
          isOpen={isOurCultureinActionOpen}
          onClose={() => setIsOurCultureinActionOpen(false)}
            ...
            <div className="mb-8">
              <h1 className=" text-2xl lg:text-3xl font-black text-gray-800 mb-4">
                {renderHighlightedText(
                  data?.mainPage.title || "TEAM GREEN",
                  "GREEN",
                )}
              </h1>
              ...
              <p className="text-gray-600 text-lg mb-8">
                {data?.mainPage.description ? (
                  ...
                  <>
                    ...
                    is powered by a team that spans disciplines, geographies,
                    and generations — but is united by one belief:
                    <br />
                    Clean energy should be reliable, inclusive, and
                    transformative.
                  </>
                )}
              </p>
            ...
            <div className="lg:hidden my-12 ">
              <h3 className="text-xl lg:text-2xl font-bold text-gray-800">
                {data?.mainPage.quote2 ? (
                  ...
                  <>
                    "Team <span className="text-[#23B14D]">GREEN</span> doesn't
                    clock in. We show up — because lives depend on it."
                  </>
                )}
              </h3>
            </div>
            <div className="space-y-12  flex flex-col  items-end">
              {data?.mainPage.keys.map((key, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="lg:flex lg:flex-row flex-col    lg:space-x-8 border-b  border-green-600 pb-4 lg:items-center lg:w-9/12 lg:justify-between"
                  >
            ...
            <div className="my-20 mb-32 lg:mb-0  lg:my-0 lg:flex justify-between">
              ...
              <div>
                {data?.mainPage.cta.map((cta, index) => {
                  const ctaProps =
                    index === 0 ? workWithUsProps : cultureBriefProps;
                  const img = (
                    <img
                      loading="lazy"
                      decoding="async"
                      src={
                        index === 0
                          ? "/images/team-green/work-with-us.png"
                          : "/images/team-green/green.png"
                      }
                      alt={cta.text}
                    />
                  );
